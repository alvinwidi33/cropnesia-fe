...
function Navbar() {
    ...
    const handleLogout = () => {
        ...
        navigate("/"); // Redirect to the home page or landing page
    };
    ...
    return (
        <React.Fragment>
            <div className="relative flex items-center justify-between">
                ...
                <button
                    className="absolute top-5 right-16 bg-[#75C4B5] text-white rounded-md hover:bg-[#2DB296] focus:outline-none w-[88px] h-9 flex items-center justify-center transition-all duration-200 active:bg-[#055C5B]"
                ...
                <p className="absolute top-7 right-44 mt-3 font-normal text-[#055C5B] font-[Inter, sans-serif]" style={{fontSize:"14px"}}>{activeUser.user?.role}</p>
            </div>
